...
export const lcWindow = document.getElementById("chat-container");
export const connectionMessage = document.getElementById("connection-message");
export const lcWindowMinimized = document.getElementById("minimized");
export const footer = document.getElementById("chat-container__footer");
...
export const textareaWrapper = document.getElementById("chat-container__textarea-wrapper");
export const input = document.getElementById("message-input");
export const minimizeButton = document.getElementById("chat-container__minimize");
